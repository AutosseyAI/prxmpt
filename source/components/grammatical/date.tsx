...
export const date: Prxmpt.EC<DateProps> = (props) => {
...
export const time: Prxmpt.EC<TimeProps> = (props) => {
  const date = new Date(props.value ?? Date.now());
...
export const datetime: Prxmpt.EC<DateTimeProps> = (props) => {
  const date = new Date(props.value ?? Date.now());
...
export const year: Prxmpt.EC<DateValuePropsProps> = (props) => {
  const date = new Date(props.value ?? Date.now());
...
export const month: Prxmpt.EC<MonthProps> = (props) => {
  const date = new Date(props.value ?? Date.now());
...
export const day: Prxmpt.EC<DayProps> = (props) => {
  const date = new Date(props.value ?? Date.now());
  if(props.format ?? "number" === "number") {
...
export const hour: Prxmpt.EC<HoursProps> = (props) => {
  const date = new Date(props.value ?? Date.now());
...
export const minute: Prxmpt.EC<DateValuePropsProps> = (props) => {
  const date = new Date(props.value ?? Date.now());
  return date.getMinutes().toString();
}

export const second: Prxmpt.EC<DateValuePropsProps> = (props) => {
  const date = new Date(props.value ?? Date.now());
  return date.getSeconds().toString();
}

export const millisecond: Prxmpt.EC<DateValuePropsProps> = (props) => {
  const date = new Date(props.value ?? Date.now());
...
export const elapsed: Prxmpt.EC<ElapsedProps> = (props) => {
